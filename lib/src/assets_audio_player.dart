...
class AssetsAudioPlayer {
          ...
          if (call.arguments == null) {
            ...
            if (_lastOpenedAssetsAudio != null) {
              ...
              if (_playlist != null) {
                ...
                print('ReadingPlaylist:${_playlist!.playlistIndex}, ${_playlist!.nextIndex()}, ${_playlist!.previousIndex()}');
  ...
  void _updatePlaylistIndexes() {
    ...
    _playlist?.clearPlayerAudio(_playlist!.isShuffling);
  }
...
class _CurrentPlaylist {
  ...
  int moveTo(int index) {
    if (index < 0) {
      playlistIndex = 0; //indexList.indexWhere((element) => element == 0);
    } else {
      playlistIndex = index; //indexList.indexWhere((element) => element == index);
    }
